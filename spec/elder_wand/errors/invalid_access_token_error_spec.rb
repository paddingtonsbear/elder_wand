  ...
  describe InvalidAccessTokenError do
    ...
    context 'token revoked' do
      it 'maps to the appropriate translation' do
        ...
        expect(subject.reason).to eq I18n.t('elder_wand.authorization.invalid_token.revoked')
      end
    end
    ...
    context 'token expired' do
      it 'maps to the appropriate translation' do
        ...
        expect(subject.reason).to eq I18n.t('elder_wand.authorization.invalid_token.expired')
      end
    end
    ...
    context 'token invalid' do
      it 'maps to the appropriate translation' do
        ...
        expect(subject.reason).to eq I18n.t('elder_wand.authorization.invalid_token.invalid')
      end
    end

    context 'invalid token scope' do
      it 'maps to the appropriate translation' do
        expect(subject.reason).to eq I18n.t('elder_wand.authorization.invalid_scope')
      end
    end
  end
end
